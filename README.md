...
9) Change the Component name to ```<image_name>_rom```, Memory Type to Single Port Rom and Port A Width and Depth according to what the Image has generated. Disable the Enable Port Type (Set it as **Always enabled**).
